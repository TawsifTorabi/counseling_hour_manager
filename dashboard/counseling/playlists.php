						...
						<div class="col-sm-12">
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="well">
										<p>
											<h3><i class="fas fa-play-circle"></i> Playlists</h3>
											<h3>Search From Playlists...</h3>
													...
													while ($rows = mysqli_fetch_array($result)) {
														...
														<tr>
															...
															<td style="font-weight:bold; font-size:12px;">
																...
																<?php echo $rows['content_count']; ?> Videos</br>
															</td>
														</tr>
														<?php
													}
					...
					*/
					...
					for (let i = 0; i < content.length; i++) {
						...
						cell4.innerHTML = 	"<i class=\"fa-solid fa-clock\"></i> "+
											...
											"<i class=\"fa-solid fa-list\"></i> "+
											content[i].content_count+" Videos</br>";

					}
				}
			};
			xhr.open('GET', 'ajax.php?data=playlistsSearch&q=' + SearchQuery, true);
			xhr.send();
		}
