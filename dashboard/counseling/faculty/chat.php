...
<html lang="en">
<head>
  <title>Faculty Admin Chat</title>
  <meta charset="utf-8">
...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      <h2><i class="fa-solid fa-notes-medical"></i> UIU Counselling Hour </br>Booking System</h2>
        ...
        <ul class="nav nav-pills nav-stacked">
		  ...
		  <li class="active"><a href="chat.php"><i class="fas fa-comment"></i> Student Chats</a></li>
    ...
    <div class="col-sm-9 main">
      ...
      <h2><i class="fas fa-comment-medical"></i> Student Chats</h2>
      <div class="row">
        <div class="col-sm-4">
          <div class="well">
            <p>
				<iframe id="AA" src="../../chat/home.php?hide=true" style="border: none; height: 80vh; width: 100%;"></iframe>
			</p> 
          </div>
        </div>
		<div class="col-sm-8">
...
<script>
  ...
  iframe.onload = function() {
    ...
    if (user !== null) {
      ...
      bb.src = "../../chat/chat.php?user=" + user + "&medical=true";
