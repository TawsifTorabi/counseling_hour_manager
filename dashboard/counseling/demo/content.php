...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      <h2><i class="fa-solid fa-notes-medical"></i> UIU Content Library</h2>
        ...
        <ul class="nav nav-pills nav-stacked">
		  ...
		  <li class="active"><a href="dashboard.php"><i class="fa-solid fa-book"></i> Library Dashboard</a></li>
	...
	<div id="w3alert" style="display: unset;" class="alert">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-5">
				<div class="well">
					<p>				
						...
						<span>
							<button class="button-amazon" onclick="showFrame()"><i class="fa-solid fa-square-arrow-up-right"></i> Read PDF Fullscreen</button>&nbsp;
			...
			?>
					<div id="dopostContainerMain">
						...
						<?php } ?>
						<span style="float: right;"><i class="fa-solid fa-clock"></i> <?php echo date("jS \of F, Y", $row['timestamp']);?> </span></br>
						<button class="button-amazon" style="float: right;" onclick="window.open('content.php?id=<?php echo $content_id;?>&revieweditable=true')"><i class="fa-solid fa-edit"></i></button></br>
						</br>
						</br>
					</div>
			
					<?php
						}else if(isset($_POST['revieweditable']) && $_POST['revieweditable']=='true'){
							...
							if(isset($_POST['editreview'])) {
								...
								$update_query = "UPDATE reviews SET review='$review', rating='$rating' WHERE review_id='$review_id'";
								...
								// Fetch the review information from the database
								$query = "SELECT review, rating FROM reviews WHERE content_id='$content_id' AND user_id='$userid'";
							...
							<div id="dopostContainerMain">
								<form name="editform" method="post" action="content.php">
									...
									<button class="button-amazon" style="margin-top: 5px; float: right;"><i class="fa-solid fa-pencil" type="editreview"></i> Update Review</button>
								</form>
							</div>
							</br>
							</br>
